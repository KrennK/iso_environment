...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='osi3/osi_sensorview.proto',
  package='osi3',
  syntax='proto2',
...
SensorView = _reflection.GeneratedProtocolMessageType('SensorView', (_message.Message,), {
  ...
  '__module__' : 'osi3.osi_sensorview_pb2'
  # @@protoc_insertion_point(class_scope:osi3.SensorView)
  })
_sym_db.RegisterMessage(SensorView)

GenericSensorView = _reflection.GeneratedProtocolMessageType('GenericSensorView', (_message.Message,), {
...
RadarSensorView = _reflection.GeneratedProtocolMessageType('RadarSensorView', (_message.Message,), {
...
LidarSensorView = _reflection.GeneratedProtocolMessageType('LidarSensorView', (_message.Message,), {
...
CameraSensorView = _reflection.GeneratedProtocolMessageType('CameraSensorView', (_message.Message,), {
...
UltrasonicSensorView = _reflection.GeneratedProtocolMessageType('UltrasonicSensorView', (_message.Message,), {
