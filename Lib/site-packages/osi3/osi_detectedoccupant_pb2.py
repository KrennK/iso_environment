...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='osi3/osi_detectedoccupant.proto',
  package='osi3',
  syntax='proto2',
...
DetectedOccupant = _reflection.GeneratedProtocolMessageType('DetectedOccupant', (_message.Message,), {

  'CandidateOccupant' : _reflection.GeneratedProtocolMessageType('CandidateOccupant', (_message.Message,), {
    'DESCRIPTOR' : _DETECTEDOCCUPANT_CANDIDATEOCCUPANT,
    '__module__' : 'osi3.osi_detectedoccupant_pb2'
