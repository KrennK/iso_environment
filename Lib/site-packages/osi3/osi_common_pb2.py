...
_BASEMOVING = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='orientation_acceleration', full_name='osi3.BaseMoving.orientation_acceleration', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='base_polygon', full_name='osi3.BaseMoving.base_polygon', index=7,
...
_WAVELENGTHDATA = _descriptor.Descriptor(
  name='WavelengthData',
  full_name='osi3.WavelengthData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='start', full_name='osi3.WavelengthData.start', index=0,
      number=1, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='end', full_name='osi3.WavelengthData.end', index=1,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='samples_number', full_name='osi3.WavelengthData.samples_number', index=2,
      number=3, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BASEMOVING.fields_by_name['orientation_acceleration'].message_type = _ORIENTATION3D
_BASEMOVING.fields_by_name['base_polygon'].message_type = _VECTOR2D
_STATEPOINT.fields_by_name['timestamp'].message_type = _TIMESTAMP
_STATEPOINT.fields_by_name['position'].message_type = _VECTOR3D
_STATEPOINT.fields_by_name['orientation'].message_type = _ORIENTATION3D
...
WavelengthData = _reflection.GeneratedProtocolMessageType('WavelengthData', (_message.Message,), {
  'DESCRIPTOR' : _WAVELENGTHDATA,
  '__module__' : 'osi3.osi_common_pb2'
  # @@protoc_insertion_point(class_scope:osi3.WavelengthData)
  })
_sym_db.RegisterMessage(WavelengthData)
