...
HostVehicleData = _reflection.GeneratedProtocolMessageType('HostVehicleData', (_message.Message,), {
  'DESCRIPTOR' : _HOSTVEHICLEDATA,
  '__module__' : 'osi3.osi_hostvehicledata_pb2'
