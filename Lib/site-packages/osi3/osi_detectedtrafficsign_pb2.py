...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='osi3/osi_detectedtrafficsign.proto',
  package='osi3',
  syntax='proto2',
...
DetectedTrafficSign = _reflection.GeneratedProtocolMessageType('DetectedTrafficSign', (_message.Message,), {

  'DetectedMainSign' : _reflection.GeneratedProtocolMessageType('DetectedMainSign', (_message.Message,), {

    'CandidateMainSign' : _reflection.GeneratedProtocolMessageType('CandidateMainSign', (_message.Message,), {
      'DESCRIPTOR' : _DETECTEDTRAFFICSIGN_DETECTEDMAINSIGN_CANDIDATEMAINSIGN,
      '__module__' : 'osi3.osi_detectedtrafficsign_pb2'
  ...
  'DetectedSupplementarySign' : _reflection.GeneratedProtocolMessageType('DetectedSupplementarySign', (_message.Message,), {

    'CandidateSupplementarySign' : _reflection.GeneratedProtocolMessageType('CandidateSupplementarySign', (_message.Message,), {
